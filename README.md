...
## 🚀 The Vision
This isn't just a resume; it's a **high-octane digital workspace**. Built with a focus on immersive aesthetics and extreme performance, this portfolio pushes the boundaries of standard HTML/CSS/JS to deliver a futuristic "Glowing Universe" experience.
...
| :--- | :--- |
| **Vanilla JS** | Intersection Observer for idle-render management, 60fps event throttling, and dynamic LinkedIn data fetching. |
| **Advanced CSS** | Custom property systems, Hardware Accelerated transforms, and GPU-optimized radial-gradient workflows. |
| **Glassmorphism** | Multi-layered backdrop-filters with tailored blur radii for optimized composition. |
| **Space Architecture** | Full-page dynamic starfields and comet logic managed via CSS keyframes and optimized DOM manipulation. |
...
This project is a testament to the power of the core web. **No npm install. No build steps. No lag.**
...
---
<p align="center">
  <i>"Fast code isn't a feature; it's a foundation."</i>
</p>
